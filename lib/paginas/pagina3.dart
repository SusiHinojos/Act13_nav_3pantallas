          ...
          return Container(
            ...
            child: Column(
              children: [
                ...
                Text(listaAtracciones[index]['nombre']!, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: purpleTheme)),
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.all(6),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.network(listaAtracciones[index]['img']!, fit: BoxFit.cover, width: double.infinity),
                    ),
                  ),
                ),
              ],
